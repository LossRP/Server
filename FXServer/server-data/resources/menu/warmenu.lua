...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].subTitle = 'Virginia State Roleplay'
	...
	menus[id].titleBackgroundColor = { r = 191, g = 10, b = 48, a = 255 }
...
function setupScaleform(scaleform)
    ...
    Button(GetControlInstructionalButton(1, 27, true))
    ButtonMessage("Up")
    PopScaleformMovieFunctionVoid()

    PushScaleformMovieFunction(scaleform, "SET_DATA_SLOT")
    PushScaleformMovieFunctionParameterInt(2)
    Button(GetControlInstructionalButton(1, 173, true))
    ButtonMessage("Down")
    PopScaleformMovieFunctionVoid()
